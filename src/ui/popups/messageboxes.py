...
def help_folder_creation():
    ...
    message = "Dieser Abschnitt erstellt alle nötigen Dateien\n" \
...
def help_raw_material():
    """Messagebox with ok Button and explanatory text"""
    message = "Dieser Abschnitt erleichtert die Arbeit mit dem Rohmaterial.\n" \
...
def help_excel():
    """Messagebox with ok Button and explanatory text"""
    message = "Dieser Abschnitt erleichtert das auswerten der Excel\n" \
...
def handle_problem_mc():
    ...
    msg.setText("Beim Einlesen der Videos Aufnahmezeiten ist ein Fehler aufgetreten."
